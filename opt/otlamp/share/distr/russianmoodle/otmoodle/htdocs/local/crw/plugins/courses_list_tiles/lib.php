...
class crw_courses_list_tiles extends local_crw_plugin 
{
    ...
    {
        global $CFG;
        require_once($CFG->dirroot .'/local/crw/plugins/courses_list_tiles/renderer.php');
        $renderer = new crw_courses_list_tiles_renderer();
