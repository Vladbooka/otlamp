...
$scenarios['unenrol_cohort'] = [
    ...
    'processors' => [
        ...
        [// формируем условия для получения enrol'ов по глобальной группе
            'type' => 'handler',
            ...
            'result_variable' => 'enrol_conditions'
        ],
        [
            'type' => 'handler',
            'code' => 'get_enrols',
            'params' => [
                'sqlconds' => '$VAR.enrol_conditions',
            ],
            'result_variable' => 'enrols'
        ],
        [// останавливаем сценарий, если подписок по группе нет
            'type' => 'handler',
            'code' => 'stop_scenario_execution',
            'preconditions' => [
                [
        ...
        [
            ...
            'code'   => 'event_based',
            'config' => [
                'scenario' => 'delete_enrol',
                'trigger_event' => false,
                'iterate_item_var_name' => 'enrol'
            ]
        ]
    ]
];