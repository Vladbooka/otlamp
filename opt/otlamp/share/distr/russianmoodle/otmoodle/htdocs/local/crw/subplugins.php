...
/**
 * Витрина курсов. Менеджер настроек сабплагинов
 *
 * @package    local
 * @subpackage crw
...
$PAGE->set_url('/local/crw/subplugins.php');
...
if ($return === 'settings') {
    $returnurl = new moodle_url('/admin/settings.php', array('section'=>'crw_settings'));
} else {
    $returnurl = new moodle_url('/admin/plugins.php');
}

$disabled = array();
$disabledsubplugins = get_config('local_crw', 'disabledsubplugins');
...
set_config('disabledsubplugins', implode(',', $disabled), 'local_crw');
