...
class local_oauth_clients_form extends moodleform {
	...
	function definition() {
		...
		$bform->addElement('text', 'preapproved_scopes', get_string('preapproved_scopes', 'local_oauth'), array('maxlength' => 1333, 'size' => 45));
		$bform->setType('preapproved_scopes', PARAM_TEXT);
	...
	function validation($data, $files) {
        ...
        if ($DB->record_exists('oauth_clients', array('client_id' => $id))) {
