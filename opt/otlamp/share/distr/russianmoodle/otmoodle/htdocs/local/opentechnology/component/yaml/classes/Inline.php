...
namespace otcomponent_yaml;

use otcomponent_yaml\Exception\DumpException;
use otcomponent_yaml\Exception\ParseException;
use otcomponent_yaml\Tag\TaggedValue;
