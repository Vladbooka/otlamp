...
/**
 * Поиск записей в таблице quiz_attempts
 *
 * @package     local_pprocessing
 * @license     http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class get_quiz_attempts extends base
{
    /**
     * {@inheritDoc}
    ...
    protected function execution_process(container $container)
    {
        ...
        $records = $DB->get_records_select('quiz_attempts', $sql, $params, $sort, $fields, $limitfrom, $limitnum);
        if (!empty($records)) {
            $result = $records;
        }
