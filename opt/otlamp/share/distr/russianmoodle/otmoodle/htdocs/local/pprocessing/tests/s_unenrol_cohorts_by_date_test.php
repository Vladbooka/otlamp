...
/**
 * Юнит-тест сценария unenrol_cohorts_by_date (Удаление подписок типа "Синхронизация с глобальной группой" по дате из настраиваемых полей глобальной группы)
 *
 * @package    local
...
class local_pprocessing_s_unenrol_cohorts_by_date_testcase extends advanced_testcase
{
    ...
    public function test_scenario() {
        ...
        set_config('unenrol_cohorts_by_date__unenroldate', 'pub_unenroldate', 'local_pprocessing');
        set_config('unenrol_cohorts_by_date__status', 1, 'local_pprocessing');
        ...
        \local_pprocessing\event\daily_executed::create()->trigger();
        // Способы записи должны быть удалены, группы и членство в группах должны остаться прежними
