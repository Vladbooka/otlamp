...
$string['preapproved_scopes'] = 'Preapproved scopes';
$string['scope_user_courses'] = 'User courses list';
$string['event_user_courses_request'] = 'User courses requested';
$string['event_user_courses_request_failed'] = 'User courses request failed';
