...
$scenarios['unenrol_cohorts_by_date'] = [
    ...
    'processors' => [
        [
            ...
            'params' => [
                ...
                'name' => [
                    'source_type' => 'static',
                    'source_value' => 'unenrol_cohorts_by_date__unenroldate'
                ]
            ],
            'result_variable' => 'mcov_unenroldate_prop'
        ],
        [// останавливаем сценарий, если кастомное поле, которое должно содержать дату - не настрено
            ...
            'preconditions' => [
                [
                    'code' => 'is_empty',
                    'params' => [
                        'value' => '$VAR.mcov_unenroldate_prop'
                    ]
                ]
            ]
        ],
