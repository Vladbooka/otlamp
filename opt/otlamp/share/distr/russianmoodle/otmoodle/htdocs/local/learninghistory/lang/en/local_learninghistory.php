...
/**
 * Strings for component 'learninghistory', language 'en'
 *
 * @package    local_learninghistory
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

$string['pluginname'] = 'Learning history';
$string['learninghistory:viewmylearninghistory'] = 'View own learning history';
$string['learninghistory:viewlearninghistoryofdeleted'] = 'View learning history of deleted courses';
$string['learninghistory:viewuserslearninghistory'] = 'View learning history of other users';

$string['index_learninghistory'] = 'Learning history';
$string['table_course'] = 'Course';
$string['table_startdate'] = 'Start date';
$string['table_enddate'] = 'End date';
$string['table_finalgrade'] = 'Final grade';
$string['table_error'] = 'Error';
$string['table_hiddencourse'] = 'Hidden course';
$string['table_accessdenied'] = 'Access denied';
$string['index_hiddencourses'] = 'Rows hidden:';
...
$string['atlastupdate'] = 'Last update: {$a}';
$string['ajax_monitoring_active'] = 'time tracking is in progress';
$string['ajax_monitoring_inactive'] = 'time tracking has been suspended';
$string['ajax_monitoring_disabled'] = 'time is tracking only when active actions are performed in the system';
...
$string['mode_help'] = 'При выборе режима работы "По действиям" не будет возникать дополнительной нагрузки при отслеживании, но данные будут менее точными. При выборе режима "Ajax-мониторинг", нагрузка на систему возрастет, но но данные будут более точными.';
