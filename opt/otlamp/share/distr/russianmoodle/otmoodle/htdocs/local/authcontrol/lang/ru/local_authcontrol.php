...
$string['back_home'] = 'Вернуться на главную страницу';
$string['title_onlineusersoverlimit'] = 'Превышена доступная нагрузка';
$string['message_onlineusersoverlimit'] = 'Приносим свои извинения за временные неудобства.
Превышено максимальное число активных пользователей.
Вы сможете продолжить работу после того как уменьшится нагрузка.';
