...
$instance = $DB->get_record('enrol', array('id' => $enrolid, 'enrol' => 'otautoenrol'), '*', MUST_EXIST);
...
$PAGE->set_url('/enrol/otautoenrol/unenrolself.php', array('enrolid' => $instance->id));
...
$message = get_string('unenrolselfconfirm', 'enrol_otautoenrol', format_string($course->fullname));
