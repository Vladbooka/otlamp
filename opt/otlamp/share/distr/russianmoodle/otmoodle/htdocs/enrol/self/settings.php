...
if ($ADMIN->fulltree) {
    ...
    $settings->add(
            new admin_setting_configselect('enrol_self/return_url', get_string('form_return_url', 'enrol_self'),
                    get_string('form_return_url_help', 'enrol_self'), 'course', $returnurls));
