...
require_once("$CFG->dirroot/enrol/dof/editenrolment_form.php");
...
$sql = "SELECT c.* $ctxsql
     ...
     LEFT JOIN {enrol} e ON e.courseid = c.id
               $ctxjoin
         WHERE e.id = :enrolid";
$params = ['contextlevel' => CONTEXT_COURSE, 'enrolid' => $ue->enrolid];
...
$url = new moodle_url('/enrol/dof/editenrolment.php', $returnurl->params());
