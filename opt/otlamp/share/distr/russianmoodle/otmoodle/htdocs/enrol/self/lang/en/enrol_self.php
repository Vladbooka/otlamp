...
If you have not done so already, you should edit your profile page so that we can learn more about you:
  ...
  {$a->profileurl}';
$string['form_return_url'] = 'После записи перенаправлять пользователя';
$string['form_return_url_help'] = 'Данная настройка позволяет задать урл-адрес страницы, на которую необходимо перенаправить пользователя после успешной записи на курс';
