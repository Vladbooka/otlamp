...
require_capability('theme/opentechnology:profile_delete', $systemcontext);
...
$PAGE->set_title(
    get_string('profile_view_title', 'theme_opentechnology')
);
...
if ( ! \theme_opentechnology\profilemanager::instance()->profile_allow_delete((int)$id) )
...
$form = new \theme_opentechnology\profiledeleteform($pageurl, $customdata);
$form->process();
