...
class potential extends base
{
     ...
     * 
     */
    public function __construct($fakeid, $code, $settingspath) 
    {
        $this->fakeid = $fakeid;
        $this->code = $code;
    ...
    {
        return get_string('profile_potential_name', 'theme_opentechnology', $this->get_code());
    }
    ...
    {
        return get_string('profile_potential_descripton', 'theme_opentechnology', $this->get_code());
    }
