...
/**
 * Отчет о пользовательских данных. Cтраница генерации PDF.
 *
 * @package    report
 * @subpackage userdata
...
$PAGE->set_url('/report/userdata/pdf.php', ['courseid' => $courseid]);
...
$reportuserdata->create_pdf('report_userdata', 'D');
