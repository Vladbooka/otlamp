...
$string['time_hint'] = 'Время учитывается в астрономических часах фактического взаимодействия слушателя с электронным курсом. Время, затраченное на учебные активности вне системы электронного обучения, время, в других электронных курсах, в мобильном приложении, а также время, затраченное на чтение и работу со скаченными из системы файлами в режиме "off-line" в данном отчете не учтено.';
