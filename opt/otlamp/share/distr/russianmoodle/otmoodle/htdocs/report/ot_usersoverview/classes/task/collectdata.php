...
namespace report_ot_usersoverview\task;
...
class collectdata extends \core\task\scheduled_task
{
    ...
    {
        return get_string('task_collectdata_title', 'report_ot_usersoverview');
    }
    ...
    {
        $enablecron = get_config('report_ot_usersoverview', 'enablecron');
        if ( ! empty($enablecron)  )
        {
            // сброс кешей
