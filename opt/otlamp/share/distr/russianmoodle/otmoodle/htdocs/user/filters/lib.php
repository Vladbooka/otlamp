...
class user_filtering {
    ...
    public function get_field($fieldname, $advanced) {
        ...
        switch ($fieldname) {
            ...
            case 'phone1':    return new user_filter_text('phone1', get_string('phone1'), $advanced, 'phone1');
            case 'phone2':    return new user_filter_text('phone2', get_string('phone2'), $advanced, 'phone2');
