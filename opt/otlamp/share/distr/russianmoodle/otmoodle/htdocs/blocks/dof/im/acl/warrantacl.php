...
//поле для сортировки списка
$sortfield = optional_param('sortfield', NULL, PARAM_ALPHA);
...
//по умолчанию сортируем по трем поям
$sort = 'plugintype ASC, plugincode ASC, code ASC, objectid ASC';
if ( ! empty($sortfield) )
{//выбрано конкретное поле для сортировки
    $sort = $sortfield.' '.$sortdirection;
}
$list = $DOF->storage('acl')->get_records(array('aclwarrantid' =>$warrantid), $sort );
