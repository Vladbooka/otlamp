 ...
 */
class dof_im_ages_order_change_status extends dof_storage_orders_baseorder
{
    ...
    protected function execute_actions($order)
    {
        ...
        //сохраняем статус
        return $this->dof->workflow('ages')->change($order->data->ageid, $order->data->newstatus, $opt);
    }
}
?>