...
$mastercourseverification = '';
if( ! empty($pitem->mdlcourse) && ! empty($pitem->id) )
{
    $mastercourseoptions = ['displayheader' => true];
    $mastercourseverification = $DOF->im('programmitems')->coursedata_verification_panel(
        $pitem->mdlcourse, 
        $pitem->id,
        $mastercourseoptions
    );
