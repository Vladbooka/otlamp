 ...
 * 
 * Данные в поле data передадутся, если в поле comparedata не содержится указанное значение
 * 
 * @package    sync
 * @subpackage transmit
...
class dof_modlib_transmit_processor_converter_general_incomparestatic extends dof_modlib_transmit_processor_base
{
    /**
