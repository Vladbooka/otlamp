...
echo '<br><ul>';
$listaddvars=array_merge($addvars,array(
        'ptype'=>'im',
        'pcode'=>'learningorders',
        'code'=>'transfer',
        'status[requested]'=>'1',
        'status[executed]'=>'1'
));
echo '<li><a href="'.$DOF->url_im('orders','/list.php',$listaddvars).'">'. $DOF->get_string('nvg_filter_orders','orders') .'</a></li>';
