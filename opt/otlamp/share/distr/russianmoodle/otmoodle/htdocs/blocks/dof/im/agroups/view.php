...
if( $DOF->storage('agroups')->is_access('edit', $agroupid, null, $departmentid) )
{
...
$linkstatushistory = $DOF->modlib('widgets')->status_link(
    ['plugintype' => 'storage', 'plugincode' => 'agroups', 'objectid' => $agroupid]
    );
...
if( $DOF->storage('agroups')->is_access('edit') )
{
