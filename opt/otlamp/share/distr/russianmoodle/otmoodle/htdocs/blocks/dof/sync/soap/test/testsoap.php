...
// // Создание метаконтракта
// $mcontract = new set_meta_contract_soap_in();
// $mcontract->id = 2000;
// $mcontract->num = 'testmetacontract';
// $mcontract->departmentcode = 'niichavo';
// //$mcontract->cov = array(1, 2, 3);
// try
// {
//     $result = $soapclient->call('set','set_meta_contract', $mcontract);
// } catch ( SoapFault $e )
// {
//     echo '<br>SoapFault caught, message: ' . $e->getMessage();
//     echo '<br>Last Response: ' . $soapclient->__getLastResponse();
// }
// echo '<br>Результат (создание метаконтракта):';
// echo '<pre>';
// var_dump($result);
// echo '</pre>';
...
// $person->departmentcode = 'niichavo';
...
// try
// {
//     $result = $soapclient->call('set','set_person', $person);
// } catch ( SoapFault $e )
// {
//     echo '<br>SoapFault caught, message: ' . $e->getMessage();
//     echo '<br>Last Response: ' . $soapclient->__getLastResponse();
// }
// echo '<br>Результат (создание персоны):';
// echo '<pre>';
// var_dump($result);
// echo '</pre>';
