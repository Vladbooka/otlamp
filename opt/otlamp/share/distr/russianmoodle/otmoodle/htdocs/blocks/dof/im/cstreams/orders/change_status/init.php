 ...
 */
class dof_im_cstreams_order_change_status extends dof_storage_orders_baseorder
{
    ...
    protected function execute_actions($order)
    {
        ...
        //сохраняем статус
        return $this->dof->workflow('cstreams')->change($order->data->cstreamid, $order->data->newstatus, $opt);
    }
}
?>