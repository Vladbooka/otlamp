...
/**
 * Обмен данных с внешними источниками. Валидация номера договора
 *
 * @package    sync
 * @subpackage transmit
...
class dof_modlib_transmit_processor_validator_contract_num extends dof_modlib_transmit_processor_base
{
    /**
