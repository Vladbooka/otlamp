 ...
 */
class dof_im_cpassed_order_change_status extends dof_storage_orders_baseorder
{
    ...
    protected function execute_actions($order)
    {
        ...
        //сохраняем статус
        return $this->dof->workflow('cpassed')->change($order->data->cpassid, $order->data->newstatus, $opt);
    }
}
?>