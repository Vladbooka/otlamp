...
/**
 * Обмен данных с внешними источниками. Конвертер пола в понятный для системы формат
 *
 * @package    sync
 * @subpackage transmit
...
class dof_modlib_transmit_processor_converter_person_gender extends dof_modlib_transmit_processor_base
{
    /**
    ...
    {
        // Доступные форматы указания пола
        $available_genders = [
            'm' => 'male',
            'м' => 'male',
            'ж' => 'female',
        ...
        return ['gender' => $available_genders[$input['gender']]];
    }
}