...
// фильтр по дисциплинам, требующим согласования мастер-курса
$conds->verificationrequested   = trim(optional_param('verificationrequested', null, PARAM_TEXT));
...
$list = $DOF->storage('programmitems')->get_listing($conds,$pages->get_current_limitfrom()-1, 
...
}else
{
    ...
    $selectlisting = $DOF->storage('programmitems')->get_select_listing($conds);
