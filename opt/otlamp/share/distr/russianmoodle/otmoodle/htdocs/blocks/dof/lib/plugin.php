...
/** Родительский объект для всех типов плагинов
 * задает их общий интерфейс.
 */
interface dof_plugin
{
     ...
     * @access public
     */
    public function catch_event($plugintype,$plugincode,$eventcode,$intvar,$mixedvar);
