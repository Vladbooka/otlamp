...
$leftblocks = array(); //хранит блоки, отображаемые на левой стороне страницы
 ...
 */  
$leftblocks[] = array('im'=>'admin','name'=>'about','id'=>1, 'title' => 'title');
//$leftblocks[] = array('im'=>'standard','name'=>'about','id'=>1, 'title' => 'title');
//$leftblocks[] = array('im'=>'exampleim','name'=>'about','id'=>1, 'title' => 'title');
