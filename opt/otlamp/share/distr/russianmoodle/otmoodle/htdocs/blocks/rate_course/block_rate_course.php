...
class block_rate_course extends block_list
{
    ...
    public function get_content() {
        ...
        if ( $PAGE->context->contextlevel == CONTEXT_COURSE || $PAGE->context->contextlevel == CONTEXT_MODULE ) 
        {
            ...
            $html .= html_writer::div($this->display_rating($COURSE->id, true),'rate_course_pixrating');
            $html .= html_writer::div(html_writer::link($url, get_string('giverating', 'block_rate_course'), [
