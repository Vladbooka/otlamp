...
class dof_modlib_transmit_processor_converter_programm_id_to_code extends dof_modlib_transmit_processor_base
{
    /**
    ...
    {
        $code = $dof->storage('programms')->get_field($input['id'], 'code');
        if ( $code )
        {// Программа найдена
            return ['code' => $code];
        }
