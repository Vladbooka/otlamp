...
/**
 * Обмен данных с внешними источниками. Валидация логина пользователя
 *
 * @package    sync
 * @subpackage transmit
...
class dof_modlib_transmit_processor_validator_general_username extends dof_modlib_transmit_processor_base
{
    /**
     ...
     * @var array
     */
    public static $slots_required = ['username' => null];
     ...
     * @var array
     */
    public static $slots_output = ['username' => null];
    ...
    {
        $username = clean_param($input['username'], PARAM_USERNAME);
        // Проверка логина
        if ($username)
        {
            // Передан корректный логин
