 ...
 */
class dof_im_programmsbcs_order_change_status extends dof_storage_orders_baseorder
{
    ...
    protected function execute_actions($order)
    {
        ...
        //сохраняем статус
        return $this->dof->workflow('programmsbcs')->change($order->data->programmsbcid, $order->data->newstatus, $opt);
    }
}
?>