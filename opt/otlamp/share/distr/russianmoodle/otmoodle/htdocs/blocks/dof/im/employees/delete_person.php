...
{// Не нашли договор
    $errorlink = $DOF->url_im('employees', '/list_appointeagreements.php', $addvars);
...
$linkyes = $DOF->url_im('employees', '/delete_person.php', $somevars);
$linkno = $DOF->url_im('employees','/list_appointeagreements.php', $addvars);
...
{// Если подтвердили удаление
    ...
    redirect($DOF->url_im('employees','/list_appointeagreements.php', $addvars) );
} else
