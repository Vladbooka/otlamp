...
/**
 * Обмен данных с внешними источниками. Конвертер идентификатора подразделения в код
 *
 * @package    sync
 * @subpackage transmit
...
class dof_modlib_transmit_processor_converter_customfield_code_to_type extends dof_modlib_transmit_processor_base
{
    /**
     ...
     * @var array
     */
    public static $slots_required = ['departmentid' => null, 'code' => null];
     ...
     * @var array
     */
    public static $slots_output = ['type' => null];
