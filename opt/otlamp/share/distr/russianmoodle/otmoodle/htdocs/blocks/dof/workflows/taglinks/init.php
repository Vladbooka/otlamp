...
/**
 * Роутер статусов для связей тегов
 *
 * @package    workflow
 * @subpackage taglinks
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class dof_workflow_taglinks implements dof_workflow
{
    /**
    ...
    {
        return array('storage'=>array('taglinks' => 2014120000,
                                      'acl'      => 2011041800 )
        );
    }
    ...
    {
        return array('storage'=>array('taglinks' => 2014110000,
                                      'acl'      => 2011041800 )
        );
    }
    /** 
    ...
    {
        return array(array('plugintype' => 'storage', 'plugincode' => 'taglinks', 'eventcode' => 'insert'));
    }
    /** 
    ...
    {
        if ( $gentype === 'storage' AND $gencode === 'taglinks' )
    ...
    public function get_available($id)
    {
        ...
        {
            case 'active':
                $statuses = array('deleted' => $this->get_name('active'));
                break;
            case 'deleted':
                $statuses = array();
                break;
