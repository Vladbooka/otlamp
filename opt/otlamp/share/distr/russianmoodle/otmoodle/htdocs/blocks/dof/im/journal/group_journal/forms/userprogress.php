...
/**
 * Страница редактирования успеваемости студента
 *
 * @package    im
 * @subpackage journal
...
$cpassedid = $addvars['cpassedid'] = optional_param('cpassedid', 0, PARAM_INT);
...
// Форма посещаемости
$url = $DOF->url_im('journal', '/group_journal/forms/userprogress.php', $addvars);

$customdata = new stdClass();
$customdata->dof = $DOF;
$customdata->lesson = $lesson;
$customdata->cpassed = $cpassedid;
$customdata->addvars = $addvars;
$customdata->cstreamid = $csid;

$form = new dof_im_journal_student_progress($url, $customdata);
$form->process();
