...
/**
 * Обмен данных с внешними источниками. Валидация договора на существование
 *
 * @package    sync
 * @subpackage transmit
...
class dof_modlib_transmit_processor_validator_contract_id_exists extends dof_modlib_transmit_processor_base
{
    /**
    ...
    {
        // Поиск договора на обучение
        $exists = $dof->storage('contracts')->is_exists((int)$input['id']);
        if ( $exists )
        {
