...
$string['unenrol_from_deleted_course'] = 'Попытка отписать пользователя (userid={$a->userid}) от удаленного курса (courseid={$a->courseid})';
$string['error_cpassed_not_found'] = 'Подписка на дисциплину не найдена';

$string['error_programmitem_not_found'] = 'Дисциплина с ID {$a} не найдена';
$string['error_programmitem_course_not_linked'] = 'Дисциплина {$a} не имеет привязки к курсу Moodle';

/**
 * Настройки
 */
$string['always_unenrol'] = 'Всегда отписывать';
$string['with_manual_creation_unenrol'] = 'Создавать ручную подписку при отсутствии других подписок и наличии дополнительных ролей';
