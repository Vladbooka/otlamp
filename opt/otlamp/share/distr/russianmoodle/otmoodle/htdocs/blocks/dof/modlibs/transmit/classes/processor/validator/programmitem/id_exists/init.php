...
/**
 * Обмен данных с внешними источниками. Валидация учебного периода на существование
 *
 * @package    sync
 * @subpackage transmit
...
class dof_modlib_transmit_processor_validator_programmitem_id_exists extends dof_modlib_transmit_processor_base
{
    /**
    ...
    {
        // Поиск периода
        $exists = $dof->storage('programmitems')->is_exists((int)$input['id']);
        if ( $exists )
        {
            return ['id' => $input['id']];
        }
