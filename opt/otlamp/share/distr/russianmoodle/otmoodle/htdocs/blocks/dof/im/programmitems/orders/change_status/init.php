 ...
 */
class dof_im_programmitems_order_change_status extends dof_storage_orders_baseorder
{
    ...
    protected function execute_actions($order)
    {
        ...
        //сохраняем статус
        return $this->dof->workflow('programmitems')->change($order->data->programmitemid, $order->data->newstatus, $opt);
    }
}
?>