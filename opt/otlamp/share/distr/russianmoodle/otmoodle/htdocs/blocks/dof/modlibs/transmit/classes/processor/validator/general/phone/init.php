...
/**
 * Обмен данных с внешними источниками. Валидация строки
 *
 * @package    sync
 * @subpackage transmit
...
class dof_modlib_transmit_processor_validator_general_phone extends dof_modlib_transmit_processor_base
{
    /**
     ...
     * @var array
     */
    public static $slots_required = ['phone' => null];
     ...
     * @var array
     */
    public static $slots_output = ['phone' => null];
    ...
    {
        // Проверка на строку
        if ( self::is_phone($input['phone']) )
        {// Передана строка
            // Возврат переданных данных
            return ['phone' => trim($input['phone'])];
        }
        return [];
    }
    
    private static function is_phone($str)
    {
