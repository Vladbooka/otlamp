...
class dof_modlib_transmit_processor_validator_general_numeric_equal extends dof_modlib_transmit_processor_base
{
    /**
     ...
     * @var array
     */
    public static $slots_required = ['numeric1' => null, 'numeric2' => null];
    ...
    {
        if ( (int)$input['numeric1'] === (int)$input['numeric2'] )
        {
