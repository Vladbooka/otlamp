...
/**
 * Обмен данных с внешними источниками. Конвертер идентификатора дисциплины в идентификатор подразделения дисциплины
 *
 * @package    sync
 * @subpackage transmit
...
class dof_modlib_transmit_processor_converter_programmitem_department_id extends dof_modlib_transmit_processor_base
{
    /**
     ...
     * @var array
     */
    public static $slots_required = ['id' => null];
    ...
    {
        $departmentid = $dof->storage('programmitems')->get_field($input['id'], 'departmentid');
