...
class dof_modlib_transmit_processor_validator_achievement_criteria_exists extends dof_modlib_transmit_processor_base
{
    /**
     ...
     * @var array
     */
    public static $slots_required = ['achievementid' => null, 'criterianum' => null, 'criteriavalue' => null];
     ...
     * @var array
     */
    public static $slots_output = ['criteriaexist' => null];
    ...
    public static function execute($input, $dof, $logger, $filemanager)
    {
        ...
        if ( $achievement )
        {
            ...
            {
                return ['criteriaexist' => $input['criteriavalue'] ];
            }
        }
        return [];
    }
