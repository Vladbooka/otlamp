...
class dof_modlib_transmit_processor_converter_department_id_to_code extends dof_modlib_transmit_processor_base
{
    /**
    ...
    {
        $item = (array)$dof->storage('departments')->get($input['id']);
        if ( ! empty($item) )
        {
