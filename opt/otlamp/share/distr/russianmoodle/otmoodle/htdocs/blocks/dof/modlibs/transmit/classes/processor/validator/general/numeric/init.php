...
/**
 * Обмен данных с внешними источниками. Валидация числа
 *
 * @package    sync
 * @subpackage transmit
...
class dof_modlib_transmit_processor_validator_general_numeric extends dof_modlib_transmit_processor_base
{
    /**
     ...
     * @var array
     */
    public static $slots_required = ['numeric' => null];
     ...
     * @var array
     */
    public static $slots_output = ['numeric' => null];
    ...
    {
        // Фильтрация numeric
        $numeric = clean_param($input['numeric'], PARAM_INT);
        if ( $numeric !== '' )
        {// Передано число
            // Возврат переданных данных
            return ['numeric' => $input['numeric']];
        }
        return [];
    }
}