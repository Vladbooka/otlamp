...
/**
 * Обмен данных с внешними источниками. Валидация учебного процесса на существование
 *
 * @package    sync
 * @subpackage transmit
...
class dof_modlib_transmit_processor_validator_cstream_id_exists extends dof_modlib_transmit_processor_base
{
    /**
    ...
    {
        // Поиск учебного процесса
        $exists = $dof->storage('cstreams')->is_exists((int)$input['id']);
        if ( $exists )
        {
            return ['id' => $input['id']];
        }
