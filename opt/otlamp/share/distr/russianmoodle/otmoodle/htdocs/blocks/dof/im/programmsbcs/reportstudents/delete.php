...
{// вывод сообщения и ничего не делаем
    print_error($DOF->get_string('notfound_report','programmsbcs', $id));
}
// проверка прав
...
$linkyes = $DOF->url_im('programmsbcs', '/reportstudents/delete.php?id='.$id.'&delete=1', $addvars);
$linkno = $DOF->url_im('programmsbcs', '/reportstudents/index.php',$addvars);
if ( $delete )
{
