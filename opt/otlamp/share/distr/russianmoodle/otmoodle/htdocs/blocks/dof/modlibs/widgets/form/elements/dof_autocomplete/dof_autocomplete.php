...
//             print_error('dof_autocomplete required options is missing');
    ...
    {
        global $DOF;
        $DOF->modlib('nvg')->add_js_code($this->get_js());
        ...
        // Формирование полей
        $this->_elements = [];
        $this->_elements[] = $this->createFormElement('text', $this->_elementName, null, $attributes);
        ...
        $this->_elements[] = $this->createFormElement('hidden', 'id_autocomplete', $this->_id_for_hidden,
                    ['id'=> $this->_elementName.'_old_hidden_id']);
        $this->_elements[] = $this->createFormElement('hidden', 'id', $this->_id_for_hidden,
                    ['id'=> $this->_elementName.'_hidden_id']);
        $this->_elements[] = $this->createFormElement('hidden', 'do', $this->_do_for_hidden,
