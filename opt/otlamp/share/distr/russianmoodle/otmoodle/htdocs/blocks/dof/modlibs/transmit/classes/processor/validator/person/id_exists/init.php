...
/**
 * Обмен данных с внешними источниками. Валидация персоны на существование
 *
 * @package    sync
 * @subpackage transmit
...
class dof_modlib_transmit_processor_validator_person_id_exists extends dof_modlib_transmit_processor_base
{
    /**
    ...
    {
        // Поиск подразделения
        $exists = $dof->storage('persons')->is_exists((int)$input['personid']);
        if ( $exists )
        {
