...
class dof_modlib_transmit_processor_converter_age_department_id extends dof_modlib_transmit_processor_base
{
    /**
    ...
    {
        $departmentid = $dof->storage('ages')->get_field($input['id'], 'departmentid');
