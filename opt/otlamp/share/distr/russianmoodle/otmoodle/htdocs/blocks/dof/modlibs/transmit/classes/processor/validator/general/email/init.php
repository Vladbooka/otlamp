...
/**
 * Обмен данных с внешними источниками. Валидация электронной почты
 *
 * @package    sync
 * @subpackage transmit
...
class dof_modlib_transmit_processor_validator_general_email extends dof_modlib_transmit_processor_base
{
    /**
    ...
    {
        // Фильтрация EMAIL
        $email = clean_param(trim($input['email']), PARAM_EMAIL);
        if ( $email )
        {// Передан Email
