...
class dof_workflow_aclwarrantagents implements dof_workflow
{
    ...
    public function change($id, $newstatus, $options=null)
    {
        ...
        // Отключаем выключение буферизации - необходимо для того, чтобы не ломалась страница, 
        // формирующаяся из буфера, во время загрузки которой происходит смена статуса (https://erm.3072.ru/issues/371)
        dof_hugeprocess(null, null, false);
