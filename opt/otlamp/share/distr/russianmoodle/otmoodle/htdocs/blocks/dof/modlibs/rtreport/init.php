 ...
 */
class dof_modlib_rtreport implements dof_plugin_modlib
{
    /**
    ...
    public function __construct($dof)
    {
        ...
        require_once $dof->plugin_path('modlib', 'rtreport', '/classes/base.php');
    }
     ...
     * 
     * @param stdClass $rtreport_type
     * @param stdClass $export
     * 
     * @return dof_modlib_rtreport_base
     */
    public function get_rtreport($plugintype, $plugincode, $code = null, $exporter = null)
    {
        $result = false;
        ...
        // получаем имя файла
        $filepath = $this->dof->plugin_path($plugintype, $plugincode, '/rtreports/' . $code . '/init.php');
        
        // получаем имя класса
        $classname = 'dof_'.$plugintype.'_'.$plugincode.'_rtreport_'.$code;
        ...
        $rtreport = new $classname();
        
        // Установка экспорта
        $rtreport->set_exporter($exporter);
