...
$url = $DOF->url_im('achievements', '/plugins/usersfilter/settings.php', $addvars);
...
// Создание формы
$settingsform = new dof_im_achievements_usersfilter_settingsform($url, $customdata);
// Обработчик настроек
