...
class dof_im_plans_edit_form extends dof_modlib_widgets_form
{
    ...
    {// делаем глобальные переменные видимыми
        ...
        $mform->addElement('hidden','showall', optional_param('showall', 0, PARAM_INT));
...
class dof_im_plans_editplanatory_form extends dof_modlib_widgets_form
{
    ...
    function definition()
    {
        ...
        $mform->addElement('editor', 'textname', '', array('cols'=>50, 'rows'=>30));
        $mform->setType('textname', PARAM_RAW);
        $mform->setDefault('textname', ['text' => $explanat, 'format' => FORMAT_HTML]);
        // кнопки
