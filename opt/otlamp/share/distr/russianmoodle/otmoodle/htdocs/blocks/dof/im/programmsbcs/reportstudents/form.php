...
class dof_im_journal_reportstudent extends dof_modlib_widgets_form
{
    /**
     * @var dof_control
     */
    ...
    {    
        ...
        $mform->addElement('date_time_selector', 'crondate', 
            $this->dof->get_string('crondate','programmsbcs').':',$options);

        $mform->addElement('submit', 'buttonshort', $this->dof->get_string('order_short_report','programmsbcs'));
        $mform->addElement('submit', 'buttonfull', $this->dof->get_string('order_full_report','programmsbcs'));
