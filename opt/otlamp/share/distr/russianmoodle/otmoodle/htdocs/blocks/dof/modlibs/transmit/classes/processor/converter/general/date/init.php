...
/**
 * Обмен данных с внешними источниками. Конвертер даты в unix timestamp
 *
 * @package    sync
 * @subpackage transmit
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class dof_modlib_transmit_processor_converter_general_date extends dof_modlib_transmit_processor_base
{
    /**
     ...
     * @var array
     */
    public static $slots_required = ['date' => null];
     ...
     * @var array
     */
    public static $slots_output = ['date' => null];
    ...
    public static function execute($input, $dof, $logger, $filemanager)
    {
        ...
        return ['date' => strtotime($input['date'])];
    }
}