 ...
 * 
 */
class dof_storage_plansections extends dof_storage
{
    /**
     * @var dof_control
     */
    ...
    public function tablename()
    {
        ...
        return 'block_dof_s_plansections';
    }
     ...
     */
    public function get_theme_plan($linktype, $linkid, $statuses=null)
    {
    	...
    	{// выберем КТ также для периода и предмета
        	...
        	{// для предмето-класса можно брать разделы из планового планирования
        	    $select .= " OR (linkid='{$linkid}' AND linktype='plan')"; 
        	}
    ...
    public function acldefault()
    {
        ...
        $a['edit']   = array('roles'=>array('manager','teacher','methodist'));
