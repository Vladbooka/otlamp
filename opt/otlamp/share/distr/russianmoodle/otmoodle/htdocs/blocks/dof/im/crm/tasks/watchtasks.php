...
$params['assignedpersonid'] = $person->id;
...
// Печатаем вкладки
echo $DOF->im('crm')->print_tab($addvars, 'tasks', 'tasksforme');

// Добавляем пагинацию к GET параметрам
$addvars['limitfrom'] = $limitfrom;
// Выводим пагинацию
echo $pages->get_navpages_list('/tasks/index.php', $addvars).'<br />';

// Выводим таблицу
$DOF->im('crm')->print_table_task($items, 'index', $addvars);

// Выводим пагинацию
echo '<br />'.$pages->get_navpages_list('/tasks/index.php', $addvars);
