...
/**
 * Обмен данных с внешними источниками. Генератор номера договора
 *
 * @package    sync
 * @subpackage transmit
...
class dof_modlib_transmit_processor_converter_contract_num_generate extends dof_modlib_transmit_processor_base
{
    /**
    ...
    public static function execute($input, $dof, $logger, $filemanager)
    {
        ...
        {// Генерация уникального номера контракта
            return ['num' => $dof->storage('contracts')->get_default_contractnum(0)];
        }
        return [];
    }
}
