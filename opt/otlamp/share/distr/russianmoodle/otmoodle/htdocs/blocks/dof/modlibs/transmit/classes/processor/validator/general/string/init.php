...
class dof_modlib_transmit_processor_validator_general_string extends dof_modlib_transmit_processor_base
{
    /**
     ...
     * @var array
     */
    public static $slots_required = ['string' => null];
     ...
     * @var array
     */
    public static $slots_output = ['string' => null];
    ...
    {
        // Проверка на строку
        if ( is_string($input['string']) )
        {// Передана строка
            // Возврат переданных данных
            return ['string' => trim($input['string'])];
        }
        return [];
    }
}