...
/**
 * Менеджер учебного плана. Базовый класс менеджера.
 * 
 * Менеджер, объединяющий в себе хранилища и роутеры статусов 
 * для реализации бизнес-логики учебного плана
 * 
 * @package    modlib
 * @subpackage learningplan
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class dof_modlib_learningplan implements dof_plugin_modlib
{
    /**
    ...
    public function __construct($dof)
    {
        ...
        require_once $dof->plugin_path('modlib', 'learningplan', '/classes/exception.php');
        // Базовый класс подсистем
        require_once $dof->plugin_path('modlib', 'learningplan', '/classes/basemanager.php');
    }
    ...
    public function get_manager($managername)
    {
        ...
        {// Подсистема не найдена
            ...
            $path = $this->dof->plugin_path('modlib', 'learningplan', '/classes/managers/'.$managername.'.php');
            if ( file_exists($path) )
            {// Подсистема найдена
                require_once $path;
                
                $managername = 'dof_modlib_learningplan_'.$managername;
