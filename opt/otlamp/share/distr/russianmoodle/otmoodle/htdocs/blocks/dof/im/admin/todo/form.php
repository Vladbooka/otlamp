...
class dof_im_admin_edit extends dof_modlib_widgets_form
{
    ...
    {// делаем глобальные переменные видимыми
        ...
        $myselect =& $mform->addElement('dof_hierselect', 'testname', $this->dof->get_string('plugin_type','admin').
        										'<br>'.$this->dof->get_string('plugin_code','admin') ,null,'<div class="col-12 px-0"></div>');
