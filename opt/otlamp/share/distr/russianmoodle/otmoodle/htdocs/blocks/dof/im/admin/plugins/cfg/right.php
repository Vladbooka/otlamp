...
$rightblocks = array(); //хранит блоки, отображаемые на правой стороне страницы
 ...
 *  $right_bloсks[код_плагина_типа_im][id_блока] = название_блока
 */  
//$rightblocks[] = array('im'=>'standard','name'=>'about','id'=>1,'title' => 'title');
//$rightblocks[] = array('im'=>'standard','name'=>'about','id'=>1,'title' => 'title');
//$rightblocks[] = array('im'=>'standard','name'=>'about','id'=>1,'title' => 'title');
//$rightblocks[] = array('im'=>'standard','name'=>'about','id'=>1,'title' => 'title'); 
