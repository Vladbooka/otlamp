...
class dof_im_inventory implements dof_plugin_im, dof_storage_config_interface
{
    ...
    public function display_delivery_set_confirmation($formdata, $depid)
    {
        ...
        $this->dof->messages->add($this->dof->get_string('set', $this->code()), DOF_MESSAGE_INFO);
        if ( $formdata->setid == 0 )
        ...
        $this->dof->messages->add($this->dof->get_string('person', 'persons').': '.$persondata, DOF_MESSAGE_INFO);
    }
