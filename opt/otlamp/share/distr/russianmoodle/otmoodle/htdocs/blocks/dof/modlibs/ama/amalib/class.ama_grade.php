...
class ama_grade extends ama_base
{
    ...
    /**
     * @deprecated легаси метод. Удалить при рефакторинге
     * 
     ...
     * @return string|false
     */
    public function get_total_grade_percentage($value = null, $itemid, $userid, $decimals = 2, $localized = true)
    {
        if ( !$grade_grade = grade_grade::fetch(['itemid' => $itemid, 'userid' => $userid]) )
        {
            return false;
        }
        $grade_grade->load_grade_item();
