...
class dof_modlib_transmit_processor_converter_appointment_email_to_id extends dof_modlib_transmit_processor_base
{
    /**
     ...
     * @var array
     */
    public static $slots_required = ['email' => null, 'programmitemid' => null];
    ...
    public static function execute($input, $dof, $logger, $filemanager)
    {
        ...
        {
            if ( $appointment->email == $input['email'] )
            {
