...
/**
 * Роутер статусов для тегов Деканата
 *
 * @package    workflow
 * @subpackage tags
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class dof_workflow_tags implements dof_workflow
{
    /**
    ...
    {
        return array(array('plugintype' => 'storage', 'plugincode' => 'tags', 'eventcode' => 'insert'),
                     array('plugintype' => 'storage', 'plugincode' => 'tags', 'eventcode' => 'soft_delete')
        );
    }
    /** 
    ...
    {
        if ( $gentype === 'storage' AND $gencode === 'tags' )
     ...
     * @return array - массив статусов в формате код => название
     */
    ...
    public function get_available($id)
    {
        ...
        {
            case 'new':
                $statuses = array('new' => $this->get_name('new'),
                                  'active' => $this->get_name('active'),
                                  'notavailable' => $this->get_name('notavailable'),
            ...
            case 'notavailable':
                ...
                break;
            case 'active':
                $statuses = array('active' => $this->get_name('notavailable'),
                                  'notavailable' => $this->get_name('notavailable'),
                                  'failed' => $this->get_name('failed'),
                                  'deleted' => $this->get_name('deleted')
                                 );
            ...
            case 'deleted':
                $statuses = array();
                break;
            case '': // чтобы была возможность изменить с пустого статуса на непросчитанный
                $statuses = array('new' => $this->get_name('new'));
                break;
