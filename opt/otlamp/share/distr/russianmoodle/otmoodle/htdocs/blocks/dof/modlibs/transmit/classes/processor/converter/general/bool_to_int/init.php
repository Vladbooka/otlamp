...
/**
 * Обмен данных с внешними источниками. Конвертер булевых данных в целые числа
 * 
 * @package    sync
 * @subpackage transmit
...
class dof_modlib_transmit_processor_converter_general_bool_to_int extends dof_modlib_transmit_processor_base
{
    /**
     ...
     * @var array
     */
    public static $slots_output = ['int' => null];
