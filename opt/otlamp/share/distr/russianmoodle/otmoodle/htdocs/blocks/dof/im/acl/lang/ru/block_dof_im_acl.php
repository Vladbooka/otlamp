...
$string['acl_link_title'] = 'права доступа';
...
$string['warrantagent_update_success'] = 'Данные поверенных успешно обновлены';
...
$string['step_one'] = 'Назначение поверенных на передаваемую доверенность';
$string['step_two'] = 'Редактирование назначений на доверенность для каждого поверенного';
$string['step_thee'] = 'Редактирование данных доверенности и передаваемых прав';
$string['go_edit_warrantagents'] = 'Перейти к редактированию назначений на доверенность для каждого поверенного';
$string['go_edit_acl_warrants'] = 'Перейти к редактированию прав для выданной доверенности';
$string['revert_edit_list_persons'] = 'Вернуться к назначению поверенных на передаваемую доверенность';
$string['revert_edit_acl_warrants'] = 'Вернуться к редактированию назначений на доверенность для каждого поверенного';
...
$string['message_next_form'] = 'На данном шаге редактируется только список поверенных. Если помимо этого больше ничего не нужно, нажмите кнопку \'\'Завершить\'\'.';
...
$string['warrants_table_warrant'] = 'Доверенность';
...
$string['isnotdelegatable'] = 'Нельзя создать субдоверенность без права передоверия';
$string['acl_create_success'] = 'Право успешно добавлено';
$string['acl_create_error'] = 'Во время добавления нового права возникла ошибка';
$string['acl_create_already_exists'] = 'Право уже существует у доверенности';
// права

//im
$string['im_achievements'] = 'Интерфейс достижений пользователей';

$string['im_achievements_achievement/create'] = 'Создание нового шаблона достижений';
$string['im_achievements_achievement/delete'] = 'Удаление шаблона достижений';
$string['im_achievements_achievement/edit'] = 'Редактирование шаблонов достижений';
$string['im_achievements_achievement/hide'] = 'Блокировка шаблона достижения для пользователей';
$string['im_achievements_achievement/show'] = 'Разблокировка шаблона достижения для пользователей';
$string['im_achievements_achievement/use'] = 'Использовать шаблон достижения';
$string['im_achievements_achievement/view'] = 'Просматривать информацию о шаблоне достижения';
$string['im_achievements_achievementins/create'] = 'Создавать новое достижение';
$string['im_achievements_achievementins/delete'] = 'Удалять достижение';
$string['im_achievements_achievementins/edit'] = 'Редактировать достижение';
$string['im_achievements_achievementins/moderate'] = 'Модерировать достижение';
$string['im_achievements_achievementins/view'] = 'Просматривать достижение';
$string['im_achievements_admnistration'] = 'Доступ к интерфейсу администрирования достижений';
$string['im_achievements_category/create'] = 'Создание раздела достижений';
$string['im_achievements_category/delete'] = 'Удаление раздела достижений';
$string['im_achievements_category/edit'] = 'Редактирование раздела достижений';
$string['im_achievements_category/hide'] = 'Блокировка раздела достижений';
$string['im_achievements_category/show'] = 'Разблокировка раздела достижений';
$string['im_achievements_category/use'] = 'Использование раздела достижений';
$string['im_achievements_category/view'] = 'Просматривать данные о разделе достижений';
$string['im_achievements_moderation'] = 'Доступ к интерфейсу модератора достижений';
$string['im_achievements_control_panel'] = 'Доступ к панели управления достижениями пользователей';
$string['im_achievements_my'] = 'Доступ к интерфейсу достижений пользователя';
$string['im_achievements_rating_availability_edit'] = 'Редактировать отображение баллов пользователя';
$string['im_achievements_rating_availability_edit/owner'] = 'Редактировать отображение собственных баллов';
$string['im_achievements_rating_export'] = 'Экспортировать таблицу рейтинга пользователей';
$string['im_achievements_rating_view'] = 'Видеть сводную таблицу рейтинга пользователей';
$string['im_achievements_user_rating_view'] = 'Видеть рейтинг пользователя';
$string['im_achievements_user_rating_view/owner'] = 'Видеть собственный рейтинг';
$string['im_achievements_otslider_view'] = 'Видеть слайдер изображений достижений';
//acl
$string['im_acl']            = 'Права доверенностей и их назначений';
...
//agroups
$string['im_agroups']                = 'Права интерфейса групп';
...
//cstreams
$string['im_cstreams']                = 'Права интерфейса учебных процессов';
...
//inventory
$string['im_inventory']      = 'Права реестра оборудования';
$string['im_inventory_view'] = 'Просмотр рееста склада учебного заведения';
//journal
$string['im_journal']                               = 'Права журнала';
...
$string['im_journal_replace_schevent']              = 'Замена занятия';
...
//obj
$string['im_obj']              = 'Права работы с любыми объектами';
...
//plans
$string['im_plans']                             = 'Права интерфейса тематических планов';
...
// participants
$string['im_participants'] = 'Интерфейс участников учебного процесса';
$string['im_participants_interface_base'] = 'Доступ к плагину';
$string['im_participants_interface_students'] = 'Доступ к панели управления Слушателями';

//schedule
$string['im_schedule']                 = 'Права интефейса шаблонов';
$string['im_schedule_create_schedule'] = 'Создание расписания';
//sel
$string['im_sel']              = 'Права интерфейса контрактов';
...
// storage
// achievements
$string['storage_achievementins_edit'] = 'Право на редактирование любых достижений';
$string['storage_achievementins_delete'] = 'Право на удаление любых достижений';
$string['storage_achievementins_edit/owner'] = 'Право на редактирование своих достижений';
$string['storage_achievementins_delete/owner'] = 'Право на удаление своих достижений';
// ages
$string['storage_ages']        = 'Права справочника периодов';
...
// agroups
$string['storage_agroups']        = 'Права справочника групп';
...
$string['storage_agroups_view_itoggrades']   = 'Просматривать ведомость итоговых оценок группы';
// appointments
$string['storage_appointments']        = 'Права справочника назначений на должность';
...
// contracts
$string['storage_contracts']        = 'Права справочника договоров учащегося';
...
// cpassed
$string['storage_cpassed']        = 'Права справочника подписок на дисциплину';
...
// cpgrades
$string['storage_cpgrades']        = 'Права справочника оценок';
...
// cstreams
$string['storage_cstreams']        = 'Права справочника учебных процессов';
...
// departments
$string['storage_departments']        = 'Права справочника подразделений';
...
// eagreements
$string['storage_eagreements']          = 'Права справочника договоров с сотрудниками';
...
// invcategories
$string['storage_invcategories']        = 'Права справочника категорий ресурсов';
...
// invitems
$string['storage_invitems']        = 'Права справочника оборудования';
...
// invsets
$string['storage_invsets']        = 'Права справочника комплектов оборудования';
...
// orders
$string['storage_orders']        = 'Права справочника приказов';
...
// persons
$string['storage_persons']        = 'Права справочника персон';
...
$string['storage_persons_viewpersonal']      = 'Просмотр личной информации о пользователе';
$string['storage_persons_viewabout']         = 'Просмотр поля &quot;Характеристика личности&quot;';
// plans
$string['storage_plans']        = 'Права справочника тем планирований';
...
// plansections
$string['storage_plansections']        = 'Права справочника тематических разделов планирований';
...
// positions
$string['storage_positions']        = 'Права справочника должностей';
...
// programmitems
$string['storage_programmitems']        = 'Права справочника дисциплин';
...
// programms
$string['storage_programms']        = 'Права справочника программ';
...
// programmsbcs
$string['storage_programmsbcs']        = 'Права справочника подписок на программу';
...
//reports
$string['storage_reports']             = 'Права справочника отчётов';
...
// schdays
$string['storage_schdays']        = 'Права справочника дней';
...
// schevents
$string['storage_schevents']             = 'Права справочника учебных событий';
...
$string['storage_schevents_view:implied']          = 'Просмотр праздничных и выходных учебных событий';
$string['storage_schevents_create/in_own_journal'] = 'Создание учебных событий в своем журнале';
// schpositions
$string['storage_schpositions']        = 'Права справочника вакансий';
...
// schtemplates
$string['storage_schtemplates']        = 'Права справочника шаблонов расписания';
...
// teachers
$string['storage_teachers']        = 'Права справочника назначений преподавателей на дисциплины';
...
// programms
$string['workflow_programms']              = 'Права рабочих процессов программ';
$string['workflow_programms_changestatus'] = 'Смена статуса программ';
// programmsbcs
$string['workflow_programmsbcs']              = 'Права рабочих процессов подписок на программы';
$string['workflow_programmsbcs_changestatus'] = 'Смена статуса подписок на программы';
// schevents
$string['workflow_schevents']              = 'Права рабочих процессов учебных событий';
...
// schpositions
$string['workflow_schpositions']              = 'Права рабочих процессов вакансий';
$string['workflow_schpositions_changestatus'] = 'Смена статуса вакансий';
// schtemplates
$string['workflow_schtemplates']              = 'Права рабочих процессов шаблонов расписания';
$string['workflow_schtemplates_changestatus'] = 'Смена статуса шаблонов расписания';
// teachers
$string['workflow_teachers']              = 'Права рабочих процессов назначений преподавателей на дисциплины';
