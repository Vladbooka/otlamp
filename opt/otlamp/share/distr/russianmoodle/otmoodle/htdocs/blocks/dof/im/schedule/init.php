 ...
 * 
 */
class dof_im_schedule implements dof_plugin_im, dof_storage_config_interface
{
    /**
     * @var dof_control
     */
    ...
    public function is_access($do, $objid = null, $userid = null, $departmentid = null)
    {
        ...
        $acldata = $this->get_access_parametrs($do, $objid, $personid, $departmentid);   
        // проверка
    ...
    public function require_access($do, $objid = NULL, $userid = NULL)
    {
        ...
        {
            $notice = "schedule/{$do} (block/dof/im/schedule: {$do})";
    ...
    public function catch_event($gentype,$gencode,$eventcode,$intvar,$mixedvar)
    {
        ...
        {
            if ( $mixedvar['storage'] == 'schtemplates' )
            {
     ...
     * @param int $personid
     */
    protected function get_access_parametrs($action, $objectid, $personid, $departmentid = null)
    {
    ...
    {
        $a = array();
        $a['create_schedule'] = ['roles'=>array('manager')];
        $a['edit:bulk'] = ['roles'=>array('manager')];
        return $a;
    }  
