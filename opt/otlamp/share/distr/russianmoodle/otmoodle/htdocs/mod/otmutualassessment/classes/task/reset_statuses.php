...
class reset_statuses extends adhoc_task
{
    /**
     * Получить имя задачи
     *
    ...
    {
        return get_string('task_reset_statuses_title', 'mod_otmutualassessment');
    }
    ...
    {
        try {
            mod_otmutualassessment_execute_task($this, ['reset_statuses']);
        } catch(\Exception $e)
        {
