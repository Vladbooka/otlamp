...
/**
 * The mod_otmutualassessment refresh grades event.
 *
...
/**
 * The mod_otmutualassessment refresh grades event class.
 *
 * @package    mod_otmutualassessment
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class refresh_grades extends \core\event\base {/**
    * Return localised event name
    * @return string
    */
    public static function get_name()
    {
        return get_string('refresh_grades', 'mod_otmutualassessment');
    }
    /**
