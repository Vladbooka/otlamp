...
class refresh_grades extends adhoc_task
{
    /**
     * Получить имя задачи
     *
    ...
    {
        return get_string('task_refresh_grades_title', 'mod_otmutualassessment');
    }
    ...
    {
        try {
            mod_otmutualassessment_execute_task($this, ['refresh_grades']);
        } catch(\Exception $e)
        {
