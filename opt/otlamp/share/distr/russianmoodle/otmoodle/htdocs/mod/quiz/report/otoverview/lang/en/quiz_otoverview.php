...
/**
 * Strings for component 'quiz_otoverview', language 'en', branch 'MOODLE_20_STABLE'
 *
...
$string['privacy:metadata:preference:quiz_otoverview_slotmarks'] = 'Whether to show marks for each question slot.';
...
$string['attemptfinished'] = 'Attempt completed';
$string['commentormark'] = 'Assessment required';
$string['regradecommentormark'] = '{$a} (Revaluation required)';
$string['waitinguseranswer'] = '{$a} (Waiting for a corrected listener response)';
$string['confirmed'] = 'Confirmed';

$string['blockdoesntexists'] = 'There is no "Teacher commentary" block in the module';
