...
/**
 * Common functions for the quiz npcmrstatistics report.
 *
 ...
 */
function quiz_npcmrstatistics_attempts_sql($quizid, \core\dml\sql_join $groupstudentsjoins,
...
/**
 * Return a {@link qubaid_condition} from the values returned by {@link quiz_npcmrstatistics_attempts_sql}.
 *
 * @param int     $quizid
 ...
 * @return        \qubaid_join
 */
function quiz_npcmrstatistics_qubaids_condition($quizid, \core\dml\sql_join $groupstudentsjoins,
        $whichattempts = QUIZ_GRADEAVERAGE, $includeungraded = false) {
    list($fromqa, $whereqa, $qaparams) = quiz_npcmrstatistics_attempts_sql(
 ...
 */
function quiz_npcmrstatistics_graph_get_new_colour() {
    debugging('The function quiz_npcmrstatistics_graph_get_new_colour() is deprecated, please do not use it any more. '
