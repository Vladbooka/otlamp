...
/**
 * Strings for component 'quiz_npcmrstatistics', language 'en', branch 'MOODLE_20_STABLE'
 *
...
$string['errornpcmrstatisticsquestions'] = 'Error fetching data to calculate statistics for question grades';
...
$string['pluginname'] = 'Statistics + question content';
...
$string['questionnpcmrstatistics'] = 'Question statistics';
$string['questionstatsfilename'] = 'questionstats';
$string['questiontype'] = 'Question type';
$string['quizinformation'] = 'Quiz information';
$string['quizname'] = 'Quiz name';
$string['quizoverallnpcmrstatistics'] = 'Quiz overall statistics';
...
$string['npcmrstatistics'] = 'Statistics + question content';
$string['npcmrstatistics:componentname'] = 'Quiz statistics report';
$string['npcmrstatisticsreport'] = 'Statistics report';
$string['npcmrstatisticsreportgraph'] = 'Statistics for question positions';
$string['npcmrstatistics:view'] = 'View statistics report';
$string['statsfor'] = 'Quiz statistics (for {$a})';
$string['variant'] = 'Variant';
$string['whichtries'] = 'Analyze responses for';
$string['fulltext'] = 'Display full text';
$string['shorttext'] = 'Display short text';
