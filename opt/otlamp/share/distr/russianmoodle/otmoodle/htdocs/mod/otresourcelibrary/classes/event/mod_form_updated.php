 ...
 */
class mod_form_updated extends \core\event\base {
    /**
     *
     * {@inheritDoc}
     * @see \core\event\base::create()
     */
    public static function form_updated($otresourcelibrary) {
        global $USER;
        $data = [];
    ...
    public static function get_name() {
        return get_string('mod_form_updated', 'mod_otresourcelibrary');
    }
}
