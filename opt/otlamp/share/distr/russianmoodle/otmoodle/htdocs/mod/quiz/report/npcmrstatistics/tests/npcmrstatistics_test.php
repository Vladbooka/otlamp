...
/**
 * Unit tests for (some of) /question/engine/npcmrstatistics.php
 *
...
/**
 * Test helper subclass of question_npcmrstatistics
 *
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class testable_question_npcmrstatistics extends \core_question\statistics\questions\calculator {
...
/**
 * Unit tests for (some of) question_npcmrstatistics.
 *
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class quiz_npcmrstatistics_question_stats_testcase extends basic_testcase {
    ...
    public function test_qstats() {
        ...
        $calculator = new testable_question_npcmrstatistics($questions);
