...
class mod_otcourselogic_renderer extends plugin_renderer_base 
{
    /**
    ...
    public function page_action_links(lesson_page $page, $printmove, $printaddpage=false) {
        ...
        if ($printmove) {
            ...
            $img = html_writer::img($this->output->image_url('t/move'), $label, array('class' => 'iconsmall'));
        ...
        $img = html_writer::img($this->output->image_url('t/edit'), $label, array('class' => 'iconsmall'));
        $actions[] = html_writer::link($url, $img, array('title' => $label));
        ...
        $img = html_writer::img($this->output->image_url('t/preview'), $label, array('class' => 'iconsmall'));
        $actions[] = html_writer::link($url, $img, array('title' => $label));
        ...
        $img = html_writer::img($this->output->image_url('t/delete'), $label, array('class' => 'iconsmall'));
        $actions[] = html_writer::link($url, $img, array('title' => $label));
