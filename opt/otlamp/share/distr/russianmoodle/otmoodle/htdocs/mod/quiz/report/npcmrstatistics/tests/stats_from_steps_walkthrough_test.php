...
require_once($CFG->dirroot . '/mod/quiz/report/npcmrstatistics/report.php');
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class quiz_report_npcmrstatistics_from_steps_testcase extends mod_quiz_attempt_walkthrough_from_csv_testcase {

    /**
     * @var quiz_npcmrstatistics_report object to do stats calculations.
     */
    protected $report;
    ...
    /**
     * Check the question stats and the response counts used in the npcmrstatistics report. If the appropriate files exist in fixtures/.
     *
    ...
    protected function check_stats_calculations_and_response_analysis($csvdata, $whichattempts, $whichtries,
        ...
        $this->report = new quiz_npcmrstatistics_report();
        ...
        $qubaids = quiz_npcmrstatistics_qubaids_condition($this->quiz->id, $groupstudentsjoins, $whichattempts);
        ...
        $quizcalc = new \quiz_npcmrstatistics\calculator();
