...
/**
 * The npcmrstatistics calculator returns an instance of this class which contains the calculated npcmrstatistics.
 *
...
class calculated {
    ...
    /* Following stats all described here : http://docs.moodle.org/dev/Quiz_npcmrstatistics_calculations#Test_npcmrstatistics  */
    ...
    public function get_formatted_quiz_info_data($course, $cm, $quiz) {
        ...
        // You can edit this array to control which npcmrstatistics are displayed.
        ...
        $quizinfo = array();
        $quizinfo[get_string('quizname', 'quiz_npcmrstatistics')] = format_string($quiz->name);
        $quizinfo[get_string('coursename', 'quiz_npcmrstatistics')] = format_string($course->fullname);
        if ($cm->idnumber) {
        ...
        if ($quiz->timeopen && $quiz->timeclose) {
            $quizinfo[get_string('duration', 'quiz_npcmrstatistics')] =
        ...
        foreach ($todisplay as $property => $format) {
            ...
            $quizinfo[get_string($property, 'quiz_npcmrstatistics',
    ...
    public function cache($qubaids) {
        ...
        // Store the data.
        $DB->insert_record('quiz_npcmrstatistics', $toinsert);

    }

    /**
     * Given a record from 'quiz_npcmrstatistics' table load the data into the properties of this class.
     *
