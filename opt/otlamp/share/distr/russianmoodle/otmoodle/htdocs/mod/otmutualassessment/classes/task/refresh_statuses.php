...
class refresh_statuses extends adhoc_task
{
    /**
     * Получить имя задачи
     *
    ...
    {
        return get_string('task_refresh_statuses_title', 'mod_otmutualassessment');
    }
    ...
    {
        try {
            mod_otmutualassessment_execute_task($this, ['refresh_statuses']);
        } catch(\Exception $e)
        {
