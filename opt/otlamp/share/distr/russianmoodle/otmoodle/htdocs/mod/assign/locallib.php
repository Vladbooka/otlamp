...
class assign {
    ...
    protected function add_attempt($userid) {
        ...
        // Trigger add attempt event
        list($course, $cm) = get_course_and_cm_from_instance($this->get_instance()->id, 'assign');
        $eventdata = [
        ...
        $event = \mod_assign\event\add_attempt::create($eventdata);
        $event->trigger();
