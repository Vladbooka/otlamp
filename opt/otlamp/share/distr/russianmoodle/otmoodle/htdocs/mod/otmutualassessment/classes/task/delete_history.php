...
class delete_history extends adhoc_task
{
    /**
     * Получить имя задачи
     *
    ...
    {
        return get_string('task_delete_history_title', 'mod_otmutualassessment');
    }
    ...
    {
        try {
            mod_otmutualassessment_execute_task($this, ['delete_history']);
        } catch(\Exception $e)
        {
