...
/**
 * Strings for component 'quiz_npcmrstatistics', language 'ru', branch 'MOODLE_35_STABLE'
 *
...
$string['errornpcmrstatisticsquestions'] = 'Ошибка выборки данных расчета статистики для оценок вопроса';
...
$string['pluginname'] = 'Статистика + содержание вопроса';
...
$string['questionnpcmrstatistics'] = 'Статистика вопроса';
...
$string['quizoverallnpcmrstatistics'] = 'Общая статистика теста';
...
$string['npcmrstatistics'] = 'Статистика + содержание вопроса';
$string['npcmrstatistics:componentname'] = 'Отчет «Статистика» по тесту';
$string['npcmrstatisticsreport'] = 'Статистический отчет';
$string['npcmrstatisticsreportgraph'] = 'Статистика по позиции вопроса';
$string['npcmrstatistics:view'] = 'Просматривать отчет «Статистика» по тесту';
$string['statsfor'] = 'Статистика теста (для {$a})';
$string['variant'] = 'Вариант';
$string['whichtries'] = 'Анализ ответов';
$string['fulltext'] = 'Показать тексты вопросов полностью';
$string['shorttext'] = 'Показать краткие версии текстов вопросов';
