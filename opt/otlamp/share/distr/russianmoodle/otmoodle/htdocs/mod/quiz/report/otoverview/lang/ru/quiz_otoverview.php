...
/**
 * Strings for component 'quiz_otoverview', language 'ru', branch 'MOODLE_35_STABLE'
 *
...
$string['commentormark'] = 'Требуется оценивание';
$string['regradecommentormark'] = '{$a} (Требуется переоценка)';
$string['waitinguseranswer'] = '{$a} (Ожидание исправленного ответа слушателя)';
$string['confirmed'] = 'Подтвержден';

$string['blockdoesntexists'] = 'Отсутствует блок "Комментарий преподавателя" в модуле';
