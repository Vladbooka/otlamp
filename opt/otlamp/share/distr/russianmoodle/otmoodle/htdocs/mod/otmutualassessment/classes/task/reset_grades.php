...
class reset_grades extends adhoc_task
{
    /**
     * Получить имя задачи
     *
    ...
    {
        return get_string('task_reset_grades_title', 'mod_otmutualassessment');
    }
    ...
    {
        try {
            mod_otmutualassessment_execute_task($this, ['reset_grades']);
        } catch(\Exception $e)
        {
