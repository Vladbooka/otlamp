...
$forcedelivery = optional_param('fd', null, PARAM_INT);
...
if (!is_null($forcedelivery) && $certificate->delivery != 3)
{// delivery==3 - это запрет генерации, при нем запрещено форсирование способа доставки
    $certificate->delivery = $forcedelivery;
}
...
switch ($tab) {
	...
	default :
		echo $simplecertificate->view_default($url, $canmanage);
	break;
}
